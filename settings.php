...
if(Authentication_Controller::IsAuthenticated())
{
    ...
    if (mb_strtoupper($_SERVER['REQUEST_METHOD']) != 'POST') {
       ...
       /* if (!preg_match("/[0-9]{2}-[0-9]{2}-[0-9]{4}/", $_POST['date']))
        {
            //$showForm=true;
            //echo '<div class="l-box-top pure-u-1"><div class="error-bar">'.$lang['INPUT_DATE_NOT_CORRECT'].'<br></div></div>';
        }
        else{
            ...
            if (!checkdate($mm,$dd,$yyyy)) {
               ...
               /* if($_POST['bankacc'] != null){
                ...
                echo '<div class="l-box-top pure-u-1"><div class="notification-bar">'.$lang['USER_DATE_CHANGED'].'<a href="'.$settings['site_url'].'my-account">'.$lang['CLICKHERE'].'</a>'.$lang['TO_CONTINUE'].'<br></div></div>';
           // }
       // }
    }
	...
	<div class="pure-u-3-4">
      ...
      $user->ShowSettingsLeftSideBar("account");
        echo '
        <div class="l-box middle-box pure-u-17-24">
            <h2>'.$lang['WELCOME'].$user->firstName.'</h2>
